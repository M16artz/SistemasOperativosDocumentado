...
4. SJF es apropiativo por ráfaga restante; RR cede al agotar quantum; FIFO conserva el orden.
5. Un RR desalojado por un nivel superior vuelve al final de su cola.
...
Con los cinco procesos de ejemplo y la política actual, el simulador produce:

- tiempo final: 35 ms;
- finalización por PID: 16, 7, 20, 35 y 28 ms;
- tiempo de ejecución medio: 19,8 ms;
- tiempo de espera medio: 11,2 ms.
